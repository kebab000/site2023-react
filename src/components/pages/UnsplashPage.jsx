...
const UnsplashPage = () => {
  ...
  const search = async (query) => {
    ...
    await fetch(`https://api.unsplash.com/search/photos?client_id=Wy3aU02kZCmqZYm8bpmsgKBccb06xdDXsWYBEjOGnPE&per_page=30&query=${query}`)
  ...
  useEffect(()=>{
    ...
    fetch("https://api.unsplash.com/photos?client_id=Wy3aU02kZCmqZYm8bpmsgKBccb06xdDXsWYBEjOGnPE&", requestOptions)
      .then(response => response.json())
