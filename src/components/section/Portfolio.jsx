        ...
        <div className="port__cont">
            <div className="port">
                <figure className="port__header">
                    <a href="/"><img src="./assets/images/port/port01.png" alt="포트폴리오"/></a>
                </figure>
            ...
            <div className="port">
                ...
                <div className="port__body">
                    <span>
                        <a href="/"><img src="./assets/images/member/member02.svg" alt="포트폴리오"/></a>
                    </span>
                    <div>
                        <h4>김도현 포트폴리오</h4>
                        <p>프론트앤드 개발자 포트폴리오</p>
            ...
            <div className="port">
                <figure className="port__header">
                    <a href="/"><img src="./assets/images/port/port03.png" alt="포트폴리오"/></a>
                </figure>
                <div className="port__body">
                    <span>
            ...
            <div className="port">
                <figure className="port__header">
                    <a href="/"><img src="./assets/images/port/port04.png" alt="포트폴리오"/></a>
                </figure>
                <div className="port__body">
                    <span>
            ...
            <div className="port">
                <figure className="port__header">
                    <a href="/"><img src="./assets/images/port/port05.png" alt="포트폴리오"/></a>
                </figure>
                <div className="port__body">
                    <span>
            ...
            <div className="port">
                <figure className="port__header">
                    <a href="/"><img src="./assets/images/port/port06.png" alt="포트폴리오"/></a>
                </figure>
                <div className="port__body">
                    <span>
